...
export class OneBotClient {
  ...
  /** 发送群聊消息 */
  async sendGroupMsg(groupId: string | number, message: string | Array<{ type: string; data: Record<string, unknown> }>): Promise<Record<string, unknown>> {
  ...
  /** 发送私聊消息 */
  async sendPrivateMsg(userId: string | number, message: string | Array<{ type: string; data: Record<string, unknown> }>): Promise<Record<string, unknown>> {
   ...
   */
  async sendGroupReply(groupId: string | number, message: string | Array<{ type: string; data: Record<string, unknown> }>, replyMsgId: string | number): Promise<Record<string, unknown>> {
